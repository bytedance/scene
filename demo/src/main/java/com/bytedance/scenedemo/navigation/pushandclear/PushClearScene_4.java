 ...
 */
public class PushClearScene_4 extends Scene {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        getView().setBackgroundColor(ColorUtil.getMaterialColor(getResources(), 5));

        TextView name = getView().findViewById(R.id.name);
        name.setText(getNavigationScene().getStackHistory());

        Button btn = getView().findViewById(R.id.btn);
        btn.setText(getString(R.string.nav_clear_task_btn_4));
