 ...
 *
 * copy from {@link androidx.savedstate.ViewTreeSavedStateRegistryOwner}
 */
/**
 * @hide
 */
@RestrictTo(LIBRARY_GROUP)
public final class SceneViewTreeSavedStateRegistryOwner {
    private SceneViewTreeSavedStateRegistryOwner() {
        // No instances
    }
