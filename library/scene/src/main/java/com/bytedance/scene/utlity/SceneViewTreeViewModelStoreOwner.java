...
/**
 * Accessors for finding a view tree-local {@link androidx.lifecycle.ViewModelStoreOwner} that allows access to a
 * {@link androidx.lifecycle.ViewModelStore} for the given view.
 *
 * copy from {@link androidx.lifecycle.ViewTreeViewModelStoreOwner}
 */
/**
 * @hide
 */
@RestrictTo(LIBRARY_GROUP)
public class SceneViewTreeViewModelStoreOwner {
    private SceneViewTreeViewModelStoreOwner() {
        // No instances
    }
