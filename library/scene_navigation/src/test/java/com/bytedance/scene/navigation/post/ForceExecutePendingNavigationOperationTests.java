...
import com.bytedance.scene.navigation.post.push.Push_Post_Lifecycle_Order;
...
public class ForceExecutePendingNavigationOperationTests {

    @LooperMode(PAUSED)
    @Test
    public void test() {
        final Push_Post_Lifecycle_Order.TestScene groupScene = new Push_Post_Lifecycle_Order.TestScene();
