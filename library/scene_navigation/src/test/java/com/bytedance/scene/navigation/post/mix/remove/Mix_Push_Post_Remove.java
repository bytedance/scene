...
public class Mix_Push_Post_Remove {
    @LooperMode(PAUSED)
    @Test
    public void test() {
        ...
        navigationScene.push(newScene, new PushOptions.Builder().setUsePost(true).build());
        ...
        navigationScene.remove(newScene);
        assertEquals(2, navigationScene.getSceneList().size());
        assertEquals("123456789", lifecycleLog.toString());
