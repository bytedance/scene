...
public class NavigationScene_Translucent_By_SetTranslucent_LifecycleTests {
    /**
     * non translucent Scene + translucent Scene
     */
    @Test
    public void testTranslucentLifecycle() {
        final NavigationScene_Translucent_By_SetTranslucent_LifecycleTests.TestScene groupScene = new NavigationScene_Translucent_By_SetTranslucent_LifecycleTests.TestScene();
        NavigationScene_Translucent_By_SetTranslucent_LifecycleTests.TestChildScene secondScene = new NavigationScene_Translucent_By_SetTranslucent_LifecycleTests.TestChildScene();
        NavigationScene_Translucent_By_SetTranslucent_LifecycleTests.TestChildScene thirdScene = new NavigationScene_Translucent_By_SetTranslucent_LifecycleTests.TestChildScene();
