...
public class NavigationScene_Translucent_By_TranslucentScene_LifecycleTests {
    /**
     * non translucent Scene + translucent Scene
     */
    @Test
    public void testTranslucentLifecycle() {
        final NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestScene groupScene = new NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestScene();
        NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestChildTranslucentScene secondScene = new NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestChildTranslucentScene();
        NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestChildScene thirdScene = new NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestChildScene();
        ...
        PushOptions pushOptions = new PushOptions.Builder().build();
    ...
    public void testTranslucentLifecycle3() {
        final NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestScene groupScene = new NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestScene();
        NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestChildTranslucentScene secondScene = new NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestChildTranslucentScene();
        NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestChildTranslucentScene thirdScene = new NavigationScene_Translucent_By_TranslucentScene_LifecycleTests.TestChildTranslucentScene();
    ...
    public void testTranslucentStopOrder() {
        ...
        navigationScene.push(new TScene() {
            @NonNull
            @Override
            public View onCreateView(@NonNull LayoutInflater inflater, @NonNull ViewGroup container, @Nullable Bundle savedInstanceState) {
                return new View(requireActivity());
    ...
    public static abstract class TScene extends Scene implements SceneTranslucent {
    ...
    public static class TestChildTranslucentScene extends TestChildScene implements SceneTranslucent {
